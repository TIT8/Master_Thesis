...
\puttitle{
	title=Analog Design, % Title of the thesis
	name=Lorenzo Perlo, % Author Name and Surname
	course=Electronic Engineering - Ingegneria elettronica, % Study Programme (in Italian)
	ID  = 996702,  % Student ID number (numero di matricola)
	advisor= Prof. Lacaita Andrea Leonardo, % Supervisor name
	coadvisor={Procházka Roman}, % Co-Supervisor name, remove this line if there is none
...
It should be a self-contained text and should be clear to someone who has not (yet) read the whole manuscript.
...
They should represent the content of your work and be specific to your field or subfield.
...
and it is assumed that the reader is familiar with the basics of creating and compiling \LaTeX{} documents (see \cite{oetiker1995not, kottwitz2015latex}). 
\\
...
The above information is provided by filling in all the entries in the command \verb|\puttitle{}|
in the title page section of this template.
\\
Be sure to select a title that is meaningful.
It should contain important keywords to be identified by the indexer.
...
\end{verbatim}
where the argument is just a text string that you will use to reference that part
...
Within the environments \texttt{table} and \texttt{tabular} you can create very fancy tables such as the one shown in Table~\ref{table:example}.
\begin{table}[H]
...
If necessary, each student is responsible for obtaining copyright permissions to include published material in the thesis.
This applies typically to third-party material published by someone else.

\section{Plagiarism}

You must be sure to respect the rules on Copyright and avoid involuntary plagiarism.
It is allowed to take other persons' ideas only if the author and his original work are clearly mentioned.
As stated in the Code of Ethics and Conduct, the Politecnico di Milano \textit{promotes the integrity of research,
condemns manipulation and infringement of intellectual property}, and allows all those
who carry out research activities to have adequate training on ethical conduct and integrity while doing research.
To be sure to respect the copyright rules, read the guides on Copyright legislation and citation styles available
at:
\begin{verbatim}
https://www.biblio.polimi.it/en/tools/courses-and-tutorials
\end{verbatim}
You can also attend the courses periodically organized on "Bibliographic citations and bibliography management".

\section{Bibliography and citations}
Your thesis must contain a suitable Bibliography which lists all the sources consulted on developing the work.
The list of references is placed at the end of the manuscript after the chapter containing the conclusions.
We suggest using the BibTeX package and saving the bibliographic references in the file \verb|Thesis_bibliography.bib|.
This is indeed a database containing all the information about the references. To cite in your manuscript, use the \verb|\cite{}| command as follows:
\\
\textit{Here is how to quote bibliography entries: \cite{knuth74}, or multiple entries at once: \cite{knuth92,lamport94}}.
\\
The bibliography and the reference list are automatically generated by running BibTeX \cite{bibtex}.

\chapter{Conclusions and future developments}
\label{ch:conclusions}%
In this chapter a final chapter containing the main conclusions of your research/study
and possible future developments of your work have to be inserted.
